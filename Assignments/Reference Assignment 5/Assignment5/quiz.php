...
$sql="SELECT MAX(Nquiz),Aquiz,Lquiz
FROM `Grades`
WHERE username='".$user."'";
$info=getDataBySQL($sql,$db);
return $info; 
    
    
}
$ar=getUserInfo($_SESSION['username']);
//$_GET["time"];
var_dump($_SESSION);
...
<div id ="q1">
    <p>What is the size of the array arr[5]?</p>
...
<p>In the image above reperesents what data structure? </p>
 <select id="qu2" name="dataS">
...
<div id="q3">
  ...
  <p>Is this a Stack?</p><span id="e3"></span>
...
<div id="q4">
    <p>b=4;</p>
     <p>t=6;</p>
     <p>b=t;</p>
    <p>What is the value of b?</p><span id="e4"></span>
     <textarea id="qu4" name="message"  cols="10">
</textarea>
</div>
<div id="t5">
<p>Which is linked List?</p><span id="e5"></span><br>
